...
public final class RheaTrace3 {
    ...
    public static final class JankEvent {
        ...
        public static final class Builder {
            ...
            public Builder setEventId(String value) { eventId = value == null ? "" : value; return this; }
            public Builder setOccurredAt(long value) { occurredAt = value; return this; }
            public Builder setSessionId(String value) { sessionId = value == null ? "" : value; return this; }
            public Builder setScene(String value) { scene = value == null ? "" : value; return this; }
            public Builder setMessageStartNs(long value) { messageStartNs = value; return this; }
            public Builder setMessageEndNs(long value) { messageEndNs = value; return this; }
            public Builder setThresholdNs(long value) { thresholdNs = value; return this; }
            public Builder setAttemptedSampleCount(long value) { attemptedSampleCount = value; return this; }
    ...
    public static BufferTimeRange getAvailableStackTimeRange() {
        return BufferTimeRange.EMPTY;
    }

    public static ExportRequestResult exportStackData(
            long startElapsedRealtimeNanos, long endElapsedRealtimeNanos,
            ExportCallback callback) {
        if (startElapsedRealtimeNanos < 0
                || endElapsedRealtimeNanos <= startElapsedRealtimeNanos) {
            return ExportRequestResult.INVALID_RANGE;
        }
        return ExportRequestResult.DISABLED;
    }
    ...
    public static ExportRequestResult exportJankTrace(JankEvent event, ExportCallback callback) {
        if (event == null) {
            return ExportRequestResult.INVALID_JANK_METADATA;
        }
        return ExportRequestResult.DISABLED;
    }
