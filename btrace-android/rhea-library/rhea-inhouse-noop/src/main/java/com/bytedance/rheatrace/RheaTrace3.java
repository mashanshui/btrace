...
public class RheaTrace3 {
    ...
    /** 在线采集配置。noop 变体保留同一编译期 API，但不会产生数据。 */
    public static final class OnlineConfig {
        ...
        public long getDumpCooldownMs() { return dumpCooldownMs; }
        ...
        public static final class Builder {
            ...
            public Builder setBufferSizeBytes(int value) { bufferSizeBytes = value; return this; }
            public Builder setMinSampleIntervalMs(long value) {
                minSampleIntervalNs = value * 1_000_000L; return this;
            }
            public Builder setPreRollMs(long value) { preRollMs = value; return this; }
            public Builder setDumpCooldownMs(long value) { dumpCooldownMs = value; return this; }
            public Builder setDiskQuotaBytes(long value) { diskQuotaBytes = value; return this; }
            public Builder setArtifactTtlMs(long value) { artifactTtlMs = value; return this; }
            public Builder setForegroundOnly(boolean value) { foregroundOnly = value; return this; }
            public Builder setEnabled(boolean value) { enabled = value; return this; }
            public Builder setMappingId(String value) { mappingId = value == null ? "" : value; return this; }
    ...
    public static final class JankEvent {
        ...
        public static final class Builder {
            ...
            public Builder setReason(String value) { reason = value == null ? "" : value; return this; }
    ...
    public static OnlineInitResult initOnline(Context context, OnlineConfig config) {
        return OnlineInitResult.DISABLED;
    }
    ...
    public static DumpRequestResult dumpJankTrace(JankEvent event, DumpCallback callback) {
        return event == null ? DumpRequestResult.INVALID_EVENT : DumpRequestResult.DISABLED;
    }
