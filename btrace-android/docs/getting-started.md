...
```powershell
java -jar rhea-trace-processor-1.0.2.jar -a rhea.sample.android -t 10 -o output.pb -r sched
```
...
```powershell
# 指定设备
java -jar rhea-trace-processor-1.0.2.jar -s SERIAL -a rhea.sample.android -t 10 -o output.pb sched

# Release 包解混淆
java -jar rhea-trace-processor-1.0.2.jar -a your.package -t 10 -m mapping.txt -o output.pb sched

# 仅采集 App 数据，绕过 Perfetto 系统采集
java -jar rhea-trace-processor-1.0.2.jar -a your.package -t 10 -mode simple -o output.pb
```
